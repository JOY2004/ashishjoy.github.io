          ...
          <div className="relative z-10 text-center text-white max-w-4xl mx-auto">
            ...
            >
              {[
                ...
                { icon: Linkedin, text: "LinkedIn", href: "https://www.linkedin.com/in/ashish-joy-7a3323229/" },
                { icon: Github, text: "GitHub", href: "https://github.com/JOY2004" },
              ].map((contact, index) => (
                <motion.a
                  key={index}
                  href={contact.href}
                  target={contact.icon === Linkedin || contact.icon === Github ? "_blank" : undefined}
                  rel={contact.icon === Linkedin || contact.icon === Github ? "noopener noreferrer" : undefined}
            ...
            >
              <div className="bg-gradient-to-br from-blue-900 to-purple-900 dark:from-gray-800 dark:to-blue-900 rounded-2xl p-12 text-white">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                  <motion.a
                    href="/resume.pdf"
                    download="Ashish_Joy_Jonnakuti_Resume.pdf"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
