      ...
      <div className="relative p-8">
        <div className="flex items-start justify-between mb-4">
          ...
          <motion.div
            ...
            className="p-2 bg-gray-100 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-300"
          >
...
const TimelineItem = ({ item, index }: { item: any; index: number }) => {
  ...
  return (
    ...
    >
      <div className="absolute left-0 top-0 w-4 h-4 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full border-4 border-white shadow-lg" />
      <div className="absolute left-2 top-4 w-0.5 h-full bg-gradient-to-b from-blue-200 to-transparent" />

      <div className="bg-white rounded-2xl shadow-lg p-6 ml-4 border border-gray-100 hover:shadow-xl transition-all duration-500">
...
export default function AnimatedPortfolio() {
  ...
  const stats = [
    ...
    { label: "Technologies Mastered", value: 12, icon: Database },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50">
      ...
      >
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto">
          <motion.div
            ...
            className="w-32 h-32 mx-auto mb-8 bg-gradient-to-br from-blue-400 to-purple-500 rounded-full flex items-center justify-center text-4xl font-bold shadow-2xl"
          >
            AJ
          </motion.div>
          ...
          <motion.div
            ...
            className="mb-4"
          >
            <p className="text-blue-300 text-lg font-medium tracking-wider uppercase mb-2">Software Engineer</p>
      ...
      <div className="relative z-10 bg-white/80 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto px-4 py-20">
          ...
          >
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8 border border-blue-100">
              <p className="text-lg text-gray-700 leading-relaxed text-center max-w-4xl mx-auto">
                Passionate Computer Science student at IIIT Dharwad with demonstrated expertise in software development,
                web technologies, and machine learning. Proven track record in full-stack development, natural language
                processing, and database management. Strong leadership experience with excellent communication skills
                and a commitment to continuous learning and innovation in emerging technologies.
              </p>
            </div>
          </motion.section>
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                  { title: "Programming", skills: ["C/C++", "Python"], icon: Code },
                  { title: "Frontend", skills: ["React", "HTML5", "CSS3", "JavaScript"], icon: Globe },
          ...
          >
            <div className="bg-gradient-to-br from-blue-900 to-purple-900 rounded-2xl p-12 text-white">
              <h2 className="text-3xl font-bold mb-4">Let's Build Something Amazing Together</h2>
              <p className="text-blue-200 mb-8 max-w-2xl mx-auto">
                I'm always excited to work on innovative projects and collaborate with talented teams. Let's connect and
